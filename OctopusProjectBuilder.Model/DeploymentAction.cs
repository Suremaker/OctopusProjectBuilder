...
namespace OctopusProjectBuilder.Model
{
    public class DeploymentAction
    {
        ...
        public DeploymentAction(string name, bool isDisabled, string actionType, IReadOnlyDictionary<string, PropertyValue> properties, IEnumerable<ElementReference> environmentRefs)
        {
            Name = name;
