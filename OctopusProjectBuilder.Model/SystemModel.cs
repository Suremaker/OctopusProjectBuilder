...
namespace OctopusProjectBuilder.Model
{
    public class SystemModel
    {
        ...
        public IEnumerable<Runbook> Runbooks { get; }

        public SystemModel(IEnumerable<MachinePolicy> machinePolicies, IEnumerable<Lifecycle> lifecycles, IEnumerable<ProjectGroup> projectGroups, IEnumerable<LibraryVariableSet> libraryVariableSets, IEnumerable<Project> projects, IEnumerable<Channel> channels, IEnumerable<Environment> environments, IEnumerable<UserRole> userRoles, IEnumerable<Team> teams, IEnumerable<Tenant> tenants, IEnumerable<TagSet> tagSets, IEnumerable<Runbook> runbooks)
        {
        ...
        public IEnumerable<SystemModel> SplitModel()
        {
            return MachinePolicies.Select(t => new SystemModel(Enumerable.Repeat(t, 1), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>()))
                ...
                .Concat(Projects.Select(prj => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Repeat(prj, 1), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                .Concat(Channels.Select(ch => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Repeat(ch, 1), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                ...
                .Concat(LibraryVariableSets.Select(lvs => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Repeat(lvs, 1), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                .Concat(UserRoles.Select(ur => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Repeat(ur, 1), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                .Concat(Teams.Select(t => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Repeat(t, 1), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                .Concat(Tenants.Select(t => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Repeat(t, 1), Enumerable.Empty<TagSet>(), Enumerable.Empty<Runbook>())))
                .Concat(TagSets.Select(t => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Repeat(t, 1), Enumerable.Empty<Runbook>())))
                .Concat(Runbooks.Select(t => new SystemModel(Enumerable.Empty<MachinePolicy>(), Enumerable.Empty<Lifecycle>(), Enumerable.Empty<ProjectGroup>(), Enumerable.Empty<LibraryVariableSet>(), Enumerable.Empty<Project>(), Enumerable.Empty<Channel>(), Enumerable.Empty<Environment>(), Enumerable.Empty<UserRole>(), Enumerable.Empty<Team>(), Enumerable.Empty<Tenant>(), Enumerable.Empty<TagSet>(), Enumerable.Repeat(t, 1))));
        }
    }
}
