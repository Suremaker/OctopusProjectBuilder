...
namespace OctopusProjectBuilder.Model
{
    public class SystemModel
    {
        ...
        public SystemModel(IEnumerable<MachinePolicy> machinePolicies, IEnumerable<Lifecycle> lifecycles, IEnumerable<ProjectGroup> projectGroups, IEnumerable<LibraryVariableSet> libraryVariableSets, IEnumerable<Project> projects, IEnumerable<Environment> environments, IEnumerable<UserRole> userRoles, IEnumerable<Team> teams, IEnumerable<Tenant> tenants, IEnumerable<TagSet> tagSets)
        {
